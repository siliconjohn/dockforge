...
const DeckSundeckHorizontal = ( props ) => {
  ...
  return (
    <g className="deck-section-vertical" data-uuid={ uuid }>
      ...
      <rect className="component-outline" x={ left } y={ bottom - height / 2 }
...
DeckSundeckHorizontal.propTypes = {
...
module.exports = DeckSundeckHorizontal
